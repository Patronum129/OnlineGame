...
public class UDP_Client : MonoBehaviour
{
    ...
    public void LeaveTheRoom()
    {
        ...
        try
        {
            string messageToSend = "LEFT ROOM";
        ...
        UnityEngine.Debug.Log("Leave the room");
    ...
    public void SendMessageToServer()
    {
        ...
        try
        {
            ...
            UnityEngine.Debug.Log("Send message to Server");
        }
        catch (Exception ex)
        {
            UnityEngine.Debug.LogWarning(ex.Message);
    ...
    private void ClientHandler()
    {
        ...
        try
        {
            ...
            string messageToSend = "JOINED ROOM";
            byte[] data = Encoding.ASCII.GetBytes(messageToSend);
        ...
        UnityEngine.Debug.Log("Joined to the room");
    ...
    private void ReciveMessage()
    {
        ...
        UnityEngine.Debug.Log("Start receive message");
        ...
        while (_connected)
        {
            try
            {
                ...
                UnityEngine.Debug.Log("Message recived: " + receivedMessage + "\t" + "message length: " + bytesRead);
