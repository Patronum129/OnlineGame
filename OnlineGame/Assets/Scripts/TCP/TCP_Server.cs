...
public class TCP_Server : MonoBehaviour
{
    ...
    public void CloseRoom()
    {
        ...
        try
        {
            ...
            UnityEngine.Debug.Log("Clients Closed");
    ...
    private void ServerHandler()
    {
        ...
        while (_connected)
        {
            try
            {
                ...
                UnityEngine.Debug.Log("Some client connected!");
            }
            catch (Exception ex)
            {
                UnityEngine.Debug.LogWarning(ex.Message);
    ...
    private void ReceiveMessage(object clientObj)
    {
        ...
        while (_connected)
        {
            try
            {
                ...
                if (bytesRead == 0)
                {
                    UnityEngine.Debug.Log("Someone leave the rooom");
    ...
    public void CopyIPAdress()
    {
        ...
        UnityEngine.Debug.Log("IP Adress Copied");
    }
}
